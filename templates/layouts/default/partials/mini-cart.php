					...
					foreach ( $cart_contents as $cart_key => $item ) :
						...
						<li class="tripzzy-cart-item">
							...
							<div class="tripzzy-cart-trip-details">
								...
								<span class="tripzzy-cart-trip-date"><strong><?php echo esc_attr( __( 'Date', 'tripzzy' ) ); ?>: </strong><?php echo esc_html( gmdate( $date_format, strtotime( $item['start_date'] ) ) ); ?></span>
								<?php if ( $time ) : ?>
								<span class="tripzzy-cart-trip-time"><strong><?php echo esc_attr( __( 'Time', 'tripzzy' ) ); ?>: </strong><?php echo esc_html( $time ); ?></span>
								<?php endif; ?>
