...
function tripzzy_set_admin_help_tab() {
	...
	$screen->add_help_tab(
		array(
			...
			'<ul>' .
				'<li>' . __( '<a href="https://docs.wptripzzy.com" target="_blank">Documentation</a> <br/>Stuck somewhere, please refer to our official documentation for assistence. It will help you to build a travel website using tripzzzy.', 'tripzzy' ) . '</li>' .
