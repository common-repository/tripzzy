	...
	<div class="tripzzy-page-header-container">
		<div class="tripzzy-page-header">
			...
			<div class="tripzzy-admin-nav">
				<a href="edit.php?post_type=tripzzy_booking" class="<?php echo esc_attr( Page::is( 'bookings', true ) ? 'current-menu-item' : '' ); ?>"><i class="fa-regular fa-rectangle-list"></i>Bookings</a>
				<a href="edit.php?post_type=tripzzy_enquiry" class="<?php echo esc_attr( Page::is( 'enquiry', true ) ? 'current-menu-item' : '' ); ?>"><i class="dashicons dashicons-format-status"></i>Enquiries</a>
				<a href="edit.php?post_type=tripzzy" class="<?php echo esc_attr( Page::is( 'trips', true ) ? 'current-menu-item' : '' ); ?>"><?php Icon::render_svg_icon( 'trip', array( 18, 18 ) ); ?>Trips</a>
			</div>
		</div>
	</div>
	<?php
