...
if ( ! class_exists( 'Tripzzy\Admin\Views\ThemesView' ) ) {
	...
	class ThemesView {
		...
		public static function render() {
			...
			if ( ! $addons_data ) {
				$addons_data = wp_remote_get( 'https://wptripzzy.com/wp-json/wp/v2/tripzzy-themes' );
				if ( isset( $addons_data['body'] ) ) {
					$addons_data = (array) json_decode( $addons_data['body'], true );
				}
