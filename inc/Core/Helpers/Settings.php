	...
	class Settings {
		...
		public static function default_settings() {
			$settings = array(
				...
				'modules'                  => array(), // value will added from modules.
				// Misc. @since 1.0.2.
		...
		private static function email_defaults() {
			...
			$defaults       = array(
				...
				'admin_from_email'                      => 'localhost' === $domain_name ? get_option( 'admin_email' ) : sprintf( 'wordpress@%s', $domain_name ),
				'customer_from_email'                   => 'localhost' === $domain_name ? get_option( 'admin_email' ) : sprintf( 'wordpress@%s', $domain_name ),
				'admin_to_emails'                       => '',
		...
		private static function trip_difficulties_defaults() {
			$defaults = array(
				...
				array(
					...
					'description' => 'Medium trip for 3-5. Weekend holiday trips',
				),
				array(
