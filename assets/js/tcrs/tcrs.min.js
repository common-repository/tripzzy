...
(() => {
  ...
  var Et = Math.pow,
    qn = (r, i, t) =>
      i in r
        ? jn(r, i, { enumerable: !0, configurable: !0, writable: !0, value: t })
        : (r[i] = t);
  ...
  var qt = (r, i) => {
      r.dispatchEvent(
        new CustomEvent("onPointerClicked", { detail: { $pointer: i } })
      );
    },
    Xt = (r, i) => {
      r.dispatchEvent(
        new CustomEvent("onMouseDown", { detail: { nativeEvent: i } })
      );
    },
    Gt = (r, i) => {
      r.dispatchEvent(
        new CustomEvent("onMouseUp", { detail: { nativeEvent: i } })
      );
    },
    Yt = (r, i) => {
      r.dispatchEvent(
        new CustomEvent("onKeyDown", { detail: { nativeEvent: i } })
      );
    },
    Zt = (r, i) => {
  ...
  var $e = [
    ...
    xn = (r, i, t) => {
      let n = null,
        ...
        m = (c, h = i) => {
          let D = [...h.classList];
          for (let g of D) g.startsWith(c) && i.classList.remove(g);
        },
        l = () => {
          m("shape");
        ...
        f = () => {
          if ((l(), !(s.length <= 0))) {
            ...
            for (let c = 1; c < s.length; c++) {
              let h = s[c];
              if (!h) continue;
              let D = i.querySelector(`.pointer-${c}`);
              !D || D.classList.add("shape", `shape-${h}`);
            }
          }
        },
        x = (c, h) => {
        ...
        T = (c, h, D) => {
          let g = t[D];
          if (!g) return;
          let S = D === 0 ? i : g.$pointer;
          if (h == null) {
            d.has(b(c, D)) && d.delete(b(c, D)), S.style.removeProperty(c);
            return;
          }
          d.set(b(c, D), h), S.style.setProperty(c, h);
        },
        C = (c, h) => d.get(b(c, h));
      return (
        (() => {
  ...
  var rt = 0,
    ...
    Dn = (r, i, t) => {
      let n = t.map((e) => e[0]),
        ...
        yt = (e) => {
          (F = e),
            F
              ...
              : document.addEventListener("wheel", Q, { passive: !1 });
        },
        Xe = (e) => {
          if (e == null) {
            p = void 0;
        ...
        Un = () => {
          qe(w(r.getAttribute(Pe))),
            (k = w(r.getAttribute(Ee))),
            (F = w(r.getAttribute(Se)));
          let e = q(r, /^pointer([0-9]*)-disabled$/, (o) => w(o));
          for (let o of e) {
            let u = o[0];
  ...
  var wn = (r, i, t) => {
    ...
    switch ((r && r.pluginsManager && r.pluginsManager.onAttrChange(i, t), i)) {
      ...
      case Ee: {
        r.keyboardDisabled = w(t);
        break;
      }
      case Se: {
        r.mousewheelDisabled = w(t);
        break;
      }
      case pe: {
        r.setData(t);
  ...
  var it = class extends HTMLElement {
      ...
      set rangeDragging(t) {
        this.slider && (this.slider.rangeDragging = w(t));
      }
      get externalCSSList() {
        ...
        (this.slider = Dn(this, n, s)),
          ...
          (this._observer = new MutationObserver((l) => {
            l.forEach((a) => {
              ...
              !f ||
                wn(this.slider, f, (x = this.getAttribute(f)) != null ? x : "");
            });
          })),
    ...
    we = it;
  window.tcRangeSlider = we;
  customElements.get("toolcool-range-slider") ||
    customElements.define("toolcool-range-slider", we);
  customElements.get("tc-range-slider") ||
    customElements.define("tc-range-slider", class extends we {});
})();
